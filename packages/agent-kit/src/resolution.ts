...
import { resolveRegistryCapability } from './registry.js';
import type {
  AgentDefinition,
  CapabilitySelection,
...
export interface ExecutionBinding {
  ...
  readonly interface: CapabilityBinding['interface'];
...
export interface IncompatibleCapability {
  ...
  readonly capability: CapabilityEntry;
  readonly profile: CapabilityProfileSummary;
  readonly registryBinding: CapabilityBinding;
...
const candidatesFor = (capability: CapabilityEntry): readonly BindingCandidate[] => {
